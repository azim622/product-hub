            ...
            <div className="container py-20 px-6 lg:px-40 mx-auto text-center">
                ...
                <div>
                    <Link to='/' className="sm:order-1 flex gap-x-1 items-center justify-center dark:text-white focus:outline-none focus:opacity-80">
                        <img src={logo} alt="" className='w-[20px] h-[20px] spin-animation' />
                        <span className='text-lg font-semibold uppercase text-[#fff]'>Zayno</span>
                    </Link>
                </div>


                <div className="mt-3">
                    <p className="text-gray-300 dark:text-neutral-300">Let's build something amazing together!</p>
                    <p className="text-gray-300 dark:text-neutral-300">© 2025 Zayno</p>
                </div>


                <div className="mt-3 space-x-2">
                    <a target='_blank' className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-300 hover:text-gray-600 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="#">
